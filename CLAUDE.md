...
Edit this file when switching gateway providers, tuning cluster-level parameters, or overriding the vLLM image. The file is committed and shared across algorithm runs.
