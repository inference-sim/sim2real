...
- _is_glob: glob metachar detection
- _expand_glob_values: mixed literal/glob expansion
...
class TestExpandGlobValues:
    ...
    def test_question_mark_glob(self):
        expanded, _ = _expand_glob_values(
            ["a?"],
            {"a1", "a2", "ab", "abc"},
        )
